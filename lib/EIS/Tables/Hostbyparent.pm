...
package EIS::Tables::Hostbyparent;
use base 'EIS::DBI';
use strict;

__PACKAGE__->set_up_table("hostbyparent");
__PACKAGE__->autoinflate("id" => "EIS::Tables::Host");
__PACKAGE__->autoinflate("hostparentid" => "EIS::Tables::Host");
__PACKAGE__->has_a("hostparentid" => "EIS::Tables::Host");
