...
EIS::Host.pm - Manages the Host table

=head1 SYNOPSIS

use EIS::Host;
my @hosts = EIS::Host->search(id=>1);

=head1 DESCRIPTION 

Teis module is used in conjunction with EIS::DBI to manage the host table
