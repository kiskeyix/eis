...
package EIS::Tables::Hostbyloc;
use base 'EIS::DBI';
use strict;

__PACKAGE__->set_up_table("hostbyloc");
__PACKAGE__->autoinflate("id" => "EIS::Tables::Host");
__PACKAGE__->autoinflate("locationid" => "EIS::Tables::Location");
__PACKAGE__->has_a("locationid" => "EIS::Tables::Location");
