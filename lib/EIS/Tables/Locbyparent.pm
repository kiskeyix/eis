...
package EIS::Tables::Locbyparent;
use base 'EIS::DBI';
use strict;

__PACKAGE__->set_up_table("locbyparent");
__PACKAGE__->autoinflate("id" => "EIS::Tables::Location");
__PACKAGE__->autoinflate("locparentid" => "EIS::Tables::Location");
